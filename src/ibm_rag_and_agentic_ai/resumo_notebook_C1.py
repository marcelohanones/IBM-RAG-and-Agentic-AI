...
sum(1 for i in chunks if str(type(i)) == "<class 'langchain_core.documents.base.Document'>") # todos os itens de chunk sao document
...
embedding_model = OpenAIEmbeddings(model=embed_params['model'], 
...
vector_store = Chroma(collection_name="split_parents",
